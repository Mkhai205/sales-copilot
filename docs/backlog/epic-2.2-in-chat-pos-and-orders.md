# Epic 2.2: Khung Lên Đơn & Quản Trị Đơn Hàng OMS (In-Chat POS & Orders)
...
> **Vị trí tài liệu**: `docs/backlog/epic-2.2-in-chat-pos-and-orders.md`\
...
3. **Ranh giới & Điều cấm (Constraints & Out-of-Scope)**:
   ...
   - ⛔ **Out-of-Scope (Không làm)**:
     ...
     - Không làm in hóa đơn nhiệt qua máy in POS K58/K80.
