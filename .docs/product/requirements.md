# Sales Copilot Platform — Product Requirements (Phase 1)

## 1. Functional Requirements

### 1.1 Multi-Tenancy & Identity
- **FR-1.1**: Hệ thống phải hỗ trợ phân quyền 2 tầng: `PlatformRole` (`SUPER_ADMIN`, `USER`) và `WorkspaceRole` (`OWNER`, `ADMIN`, `AGENT`, `VIEWER`).
...
### 1.5 Auto-Assignment & Operations
...
- **NFR-3 (Idempotency)**: Đảm bảo không trùng lặp tin nhắn khi nhà mạng / nền tảng gửi lại Webhook nhiều lần.
