...
function Sidebar({
  ...
  return (
    <div
      className={cn(
        'group peer hidden text-sidebar-foreground md:block relative h-full',
        className,
      )}
      data-state={state}
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'relative flex w-full flex-1 flex-col bg-background md:peer-data-[variant=inset]:shadow-sm',
        className,
      )}
      {...props}
    />
