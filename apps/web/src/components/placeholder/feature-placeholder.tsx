...
export function FeaturePlaceholder({
  ...
  return (
    <div className="flex h-full w-full flex-col overflow-y-auto bg-background p-6 gap-5">
      {/* Header section */}
      <div className="flex flex-col gap-3 pb-3 border-b border-border/70 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="flex size-10 items-center justify-center rounded-xl bg-primary/10 text-primary ring-1 ring-primary/20 shadow-xs">
        ...
        <div className="rounded-lg border border-border/80 bg-background/80 p-4 shadow-xs backdrop-blur-xs flex items-start gap-3">
          ...
          <div className="text-xs text-muted-foreground leading-relaxed">
            <span className="font-semibold text-foreground">
              {'Kết nối đa kênh thời gian thực:'}
            </span>{' '}
            {
