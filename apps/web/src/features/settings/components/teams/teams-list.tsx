      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 items-center gap-2.5">
          ...
          {teams && (
            ...
            >
              {filteredTeams.length} {filteredTeams.length === 1 ? 'nhóm' : 'nhóm'}
            </Badge>
          )}
        </div>
                    ...
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="flex flex-col min-w-0">
                        ...
                        <span className="text-[11px] text-muted-foreground">
                          {memberCount} {memberCount === 1 ? 'thành viên' : 'thành viên'}
                        </span>
                      </div>
                    </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-xs">
              ...
              <strong className="text-foreground font-semibold">"{teamToDelete?.name}"</strong>? Các
              phân công hội thoại và liên kết thành viên thuộc nhóm này sẽ bị gỡ bỏ. Hành động này
              không thể hoàn tác.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
