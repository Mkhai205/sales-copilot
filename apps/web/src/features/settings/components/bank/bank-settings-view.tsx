    ...
    <SettingsGuard workspaceSlug={workspaceSlug} segment="bank">
      <div className="flex flex-col flex-1 h-full overflow-y-auto bg-background p-6 gap-5">
        <PageHeader
          ...
          description="Cấu hình tài khoản ngân hàng để tạo mã VietQR chuẩn NAPAS 247 và tích hợp webhook đối soát tự động."
          icon={Landmark}
        />
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Cung cấp mã BIN và thông tin tài khoản ngân hàng. Dữ liệu này dùng để tạo mã
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-[10.5px] text-muted-foreground">
                      Mã định danh BIN gồm 6 chữ số của ngân hàng (Ví dụ: 970415 cho VietinBank,
                      970436 cho Vietcombank).
                    </p>
                  </div>
