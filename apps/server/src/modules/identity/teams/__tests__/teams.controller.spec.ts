...
describe('TeamsController (Presentation Layer Endpoints)', () => {
  ...
  beforeEach(() => {
    mockTeamsService = {
      listTeams: async (_workspaceId: string) => [sampleTeam],
      createTeam: async (workspaceId: string, dto: any) => ({
        ...sampleTeam,
        name: dto.name,
        description: dto.description,
      }),
      getTeamById: async (_workspaceId: string, _teamId: string) => sampleTeam,
      updateTeam: async (workspaceId: string, teamId: string, dto: any) => ({
        ...sampleTeam,
        ...dto,
      }),
      deleteTeam: async (_workspaceId: string, _teamId: string) => ({ success: true }),
      ...
      removeTeamMembers: async (_workspaceId: string, _teamId: string, _userIds: string[]) => ({
        success: true,
      }),
    };
