...
export class ContactsController {
  ...
  async mergeContacts(
    ...
    return this.contactsService.merge(context.workspaceId, dto.baseContactId, dto.mergeeContactId, {
  ...
  async listContactIdentities(
    ...
    return this.contactsService.findIdentitiesByContactId(context.workspaceId, contactId);
  }
  ...
  async linkContactIdentity(
    ...
    return this.contactsService.linkIdentity(context.workspaceId, contactId, dto);
  }
  ...
  async unlinkContactIdentity(
    ...
    return this.contactsService.unlinkIdentity(context.workspaceId, contactId, identityId);
  }
}
