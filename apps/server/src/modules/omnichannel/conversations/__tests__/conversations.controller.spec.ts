...
describe('ConversationsController (Presentation Layer Endpoints)', () => {
  ...
  beforeEach(() => {
    ...
    mockConversationsService = {
      ...
      getCounts: async (_workspaceId: string, _status?: any, _userId?: string) => ({
        mine: 6,
        unassigned: 10,
        all: 16,
      }),
      ...
      assign: async (workspaceId: string, id: string, dto: any, _userId?: string) => ({
        id,
        displayId: 1,
        workspaceId,
        assigneeId: dto.assigneeId ?? null,
      ...
      getLabels: async (workspaceId: string, _id: string) => [
        {
          id: 'lbl_1',
          workspaceId,
          title: 'VIP',
      ...
      assignLabels: async (workspaceId: string, _id: string, _labelIds: string[]) => [
        {
          id: 'lbl_1',
          workspaceId,
          title: 'VIP',
