...
describe('Commerce Shared Contracts & Schemas', () => {
  describe('Enums Integrity', () => {
    it('should have correct queue and job names with backward compatibility', () => {
    ...
    it('should have correct commerce realtime event strings', () => {
      ...
      assert.strictEqual(WsClientEvent.POS_EDITING_HEARTBEAT, 'commerce.editing_heartbeat');
      assert.strictEqual(WsClientEvent.COMMERCE_EDITING_STOP, 'commerce.editing_stop');
      assert.strictEqual(WsClientEvent.POS_EDITING_STOP, 'commerce.editing_stop');
      assert.strictEqual(WsClientEvent.COMMERCE_EDITING_TAKEOVER, 'commerce.editing_takeover');
      assert.strictEqual(WsClientEvent.POS_EDITING_TAKEOVER, 'commerce.editing_takeover');
    });
